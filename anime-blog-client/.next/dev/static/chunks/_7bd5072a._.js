...
function SinglePostPage() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "SinglePostPage.useEffect": ()=>{
            const fetchPostData = {
                "SinglePostPage.useEffect.fetchPostData": async ()=>{
                    try {
                        // משיכת הפוסט הספציפי והתגובות שלו
                        const [postRes, commentsRes, allPublishedRes] = await Promise.all([
                            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].get(`${("TURBOPACK compile-time value", "http://localhost:5000/api")}/posts/${id}`),
                            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].get(`${("TURBOPACK compile-time value", "http://localhost:5000/api")}/comments/post/${id}`),
                            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].get(`${("TURBOPACK compile-time value", "http://localhost:5000/api")}/posts/published`) // מושכים גם את שאר הכתבות
                        ]);
                        setPost(postRes.data);
                        setComments(commentsRes.data);
                        // סינון 4 הכתבות האחרונות שהוספו לקרוסלה (לא כולל הכתבה שאנחנו קוראים עכשיו)
                        const topFeatured = allPublishedRes.data.filter({
                            "SinglePostPage.useEffect.fetchPostData.topFeatured": (p)=>p.isFeatured && p._id !== id
                        }["SinglePostPage.useEffect.fetchPostData.topFeatured"]).sort({
                            "SinglePostPage.useEffect.fetchPostData.topFeatured": (a, b)=>new Date(b.featuredAt || 0) - new Date(a.featuredAt || 0)
                        }["SinglePostPage.useEffect.fetchPostData.topFeatured"]).slice(0, 4);
            ...
            }["SinglePostPage.useEffect.fetchPostData"];
            fetchPostData();
        }
    }["SinglePostPage.useEffect"], [
        id
                                ...
                                children: [
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        ...
                                        children: [
                                            ...
                                            fp.tags && fp.tags.length > 0 && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
...
_s(SinglePostPage, "67NT49fhq1NmvoOKPLnir7Nl84c=", false, function() {
    return [
...
//# sourceMappingURL=_7bd5072a._.js.map