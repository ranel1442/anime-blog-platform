...
function CommunityPage() {
    ...
    // סטייטים בשביל טופס יצירת פוסט חדש
    ...
    // משיכת פוסטים של הקהילה כשהעמוד עולה
    ...
    const handleCreatePost = async (e)=>{
        ...
        // הפיכת התגיות (מחרוזת מופרדת בפסיקים) למערך
        ...
        try {
            ...
            // נוסיף את הפוסט החדש לתחילת הרשימה (כדי לראות אותו מיד)
            // מכיוון שהשרת החזיר לנו את הפוסט בלי ה-populate של המשתמש, נוסיף לו את פרטי היוזר שלנו ידנית לתצוגה
            const createdPost = {
                ...res.data.post,
                author: {
            ...
            alert("הייתה בעיה ביצירת הפוסט.");
        }
    };
    // פונקציית לייק לפוסט קהילה
    const handleLike = async (postId, currentLikes)=>{
        if (!user) return alert("יש להתחבר כדי לעשות לייק!");
        try {
            const res = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].post(`${("TURBOPACK compile-time value", "http://localhost:5000/api")}/community-posts/${postId}/like`, {}, {
                headers: {
                    Authorization: `Bearer ${token}`
                }
            });
            // עדכון מספר הלייקים במסך
            setPosts(posts.map((post)=>{
                if (post._id === postId) {
                    // מנגנון זמני להצגת הלייק על המסך עד לרענון
            ...
            children: [
                ...
                showForm && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("form", {
                    ...
                    children: [
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("input", {
                            type: "text",
                            placeholder: "תגיות (מופרדות בפסיקים, למשל: מנגה, המלצה, וואן פיס)",
...
//# sourceMappingURL=_52656a36._.js.map